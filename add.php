...
<body>
    ...
    <form action="add_process.php" method="post">
        ...
        <select id="set" name="set" required>
            <option value="" selected hidden required>请选择圣遗物套装</option>
        ...
        <select id="part" name="part" required>
            <option value="" selected hidden required>请选择圣遗物部位</option>
        ...
        <select id="main_substat" name="main_substat" required>
            <option value="" selected hidden required>请选择主词条属性</option>
        ...
        <label>圣遗物等级：</label>
        <input type="number" id="level" name="level" min="0" max="20" step="1" required><br>

        <label>副词条1：</label>
        <select id="adverb_substat_1" name="adverb_substat_1" required>
        <option value="" selected hidden required>请选择副词条1属性</option>
        <option value="攻击力">攻击力</option>
        <option value="攻击力百分比">攻击力百分比</option>
        ...
        <label>副词条1数值：</label>
        <input type="number" id="adverb_substat_1_data" name="adverb_substat_1_data" min="0" max="9999" step="0.1" required><br>

        <label>副词条2：</label>
        <select id="adverb_substat_2" name="adverb_substat_2" required>
        <option value="" selected hidden required>请选择副词条2属性</option>
        <option value="攻击力">攻击力</option>
        <option value="攻击力百分比">攻击力百分比</option>
        <option value="防御力">防御力</option>
        <option value="防御力百分比">防御力百分比</option>
        ...
        <label>副词条2数值：</label>
        <input type="number" id="adverb_substat_2_data" name="adverb_substat_2_data" min="0" max="9999" step="0.1" required><br>

        <label>副词条3：</label>
        <select id="adverb_substat_3" name="adverb_substat_3" required>
        <option value="" selected hidden required>请选择副词条3属性</option>
        <option value="攻击力">攻击力</option>
        <option value="攻击力百分比">攻击力百分比</option>
        <option value="防御力">防御力</option>
        <option value="防御力百分比">防御力百分比</option>
        ...
        <label>副词条3数值：</label>
        <input type="number" id="adverb_substat_3_data" name="adverb_substat_3_data" min="0" max="9999" step="0.1" required><br>

        <label>副词条4：</label>
        <select id="adverb_substat_4" name="adverb_substat_4" required>
        <option value="" selected hidden required>请选择副词条4属性</option>
        <option value="攻击力">攻击力</option>
        <option value="攻击力百分比">攻击力百分比</option>
        <option value="防御力">防御力</option>
        <option value="防御力百分比">防御力百分比</option>
        ...
        <label>副词条4数值：</label>
        <input type="number" id="adverb_substat_4_data" name="adverb_substat_4_data" min="0" max="9999" step="0.1" required><br>
